...
def part_3_render_view(view_mode, filtered_df, display_df, df):
    ...
    # =========================================================================
    # ВАРИАНТ Б: ПОЛНАЯ АНКЕТА (Строгий монохромный список по умолчанию)
    # =========================================================================
    else:
